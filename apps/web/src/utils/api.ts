...
interface PropertyResolveResponse {
  id: string;
...
export function setApiAccessTokenResolver(_resolver?: unknown): void {}
...
// Get the API URL for the active browser runtime.
// - If VITE_API_URL is set to a non-loopback address, use it as-is.
// - Otherwise reuse the current page host for LAN browsing.
