 ...
 *
 * Portrait state model matches the legacy mobile sheet behavior:
...
/** Map SheetState to the legacy mobile sheet index semantics. */
...
if (typeof document !== 'undefined') {
  ...
  style.textContent = `
    ...
    /* bottom: 49px positions the sheet above the tab bar, matching native
       the old mobile sheet, which rendered within the content area above the tab bar */
...
export const PropertyBottomSheet = forwardRef<PropertyBottomSheetRef, PropertyBottomSheetProps>(
  function PropertyBottomSheet(
    ...
    // Expose ref methods matching the historical sheet behavior.
      ...
      <>
        ...
        >
          ...
          <div
            ...
            onScroll={(e) => { scrollTopRef.current = (e.currentTarget as HTMLDivElement).scrollTop; }}
          >
