...
describe('GroupPreviewCard', () => {
  ...
  describe('single property', () => {
    ...
    it('fires onPropertyTap when card body is pressed', () => {
      ...
      fireEvent.click(screen.getByText('Teststraat 42'));
  ...
  describe('quick actions', () => {
    ...
    it('fires onLike with current property', () => {
      ...
      fireEvent.click(screen.getByTestId('group-preview-like-button'));
    ...
    it('fires onComment with current property', () => {
      ...
      fireEvent.click(screen.getByTestId('group-preview-comment-button'));
    ...
    it('fires onGuess with current property', () => {
      ...
      fireEvent.click(screen.getByTestId('group-preview-guess-button'));
  ...
  describe('cluster (multiple properties)', () => {
    ...
    it('fires onIndexChange when right arrow is pressed', () => {
      ...
      fireEvent.click(screen.getByTestId('group-preview-nav-right'));
    ...
    it('fires onIndexChange when left arrow is pressed', () => {
      ...
      fireEvent.click(screen.getByTestId('group-preview-nav-left'));
      expect(onIndexChange).toHaveBeenCalledWith(1);
    });
    ...
    it('close button works in cluster mode', () => {
      ...
      fireEvent.click(screen.getByTestId('group-preview-close-button'));
      expect(onClose).toHaveBeenCalledTimes(1);
    });
    ...
    it('fires onPropertyTap with the correct cluster property', () => {
      ...
      fireEvent.click(screen.getByText('Straat 2'));
