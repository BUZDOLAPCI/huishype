...
test.describe(`Reference Expectation: ${EXPECTATION_NAME}`, () => {
  ...
  test('verify card tap opens bottom sheet', async ({ page }) => {
    ...
    if (previewVisible) {
      ...
      const previewCardBody = page.locator('[data-testid="property-preview-card"]').first();
      console.log('Clicking preview card body to open bottom sheet');
      await previewCardBody.click({ force: true });
