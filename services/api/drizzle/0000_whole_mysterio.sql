...
CREATE TABLE "osm_buildings" (
	...
	"osm_id" bigint,
	"render_height" real DEFAULT 6 NOT NULL,
	"render_min_height" real DEFAULT 0 NOT NULL,
...
CREATE TABLE "price_guesses" (
	...
	"is_meme_guess" boolean DEFAULT false NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "properties" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"country_code" varchar(2) DEFAULT 'NL' NOT NULL,
...
CREATE TABLE "users" (
	...
	"last_display_name_change_at" timestamp with time zone,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE UNIQUE INDEX "osm_buildings_osm_id_idx" ON "osm_buildings" USING btree ("osm_id") WHERE osm_id IS NOT NULL;--> statement-breakpoint
CREATE INDEX "idx_osm_buildings_geometry" ON "osm_buildings" USING gist ("geometry");--> statement-breakpoint
...
CREATE UNIQUE INDEX "properties_national_id_idx" ON "properties" USING btree ("country_code","national_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "properties_address_unique_idx" ON "properties" USING btree ("country_code","street","postal_code","house_number","house_number_addition");--> statement-breakpoint
CREATE INDEX "properties_created_at_idx" ON "properties" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "properties_country_code_idx" ON "properties" USING btree ("country_code");--> statement-breakpoint
CREATE INDEX "properties_geometry_gist_idx" ON "properties" USING gist ("geometry");--> statement-breakpoint
...
CREATE INDEX "property_views_property_viewed_at_idx" ON "property_views" USING btree ("property_id","viewed_at");--> statement-breakpoint
