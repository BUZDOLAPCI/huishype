...
function buildMagicLinkEmailHtml(
  ...
  return [
    ...
    '    .button-wrap { width: 380px !important; max-width: 380px !important; }',
    '    @media only screen and (max-width: 600px) {',
    '      .wrapper { width: 100% !important; padding-left: 20px !important; padding-right: 20px !important; }',
    '      .button-wrap { width: 100% !important; max-width: 100% !important; }',
    '    }',
    '  </style>',
    '</head>',
    ...
    '                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="380" class="button-wrap" style="width:380px;max-width:380px;">',
    '                  <tr>',
    `                    <td align="center"><a class="button" href="${escapedMagicLink}" style="display:block;padding:16px 24px;border-radius:8px;background:#fdae10;color:#ffffff;font-size:16px;font-weight:800;line-height:24px;box-shadow:0 10px 24px rgba(253,174,16,0.28);">Sign in to HuisHype</a></td>`,
    '                  </tr>',
    '                </table>',
    '              </td>',
    '            </tr>',
