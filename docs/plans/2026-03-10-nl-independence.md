...
- **Per-query country filtering**: Photon supports `&countrycode=XX` (single ISO 3166-1 alpha-2 code per query) to scope search to the user's current context. Additional filters: `bbox`, `osm_tag`, `state`, `city`, `postcode`, `district`.
